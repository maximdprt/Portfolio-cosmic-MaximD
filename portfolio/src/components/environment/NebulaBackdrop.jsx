...
export default function NebulaBackdrop({ quality = 'high' }) {
  const mat = useMemo(() => new THREE.ShaderMaterial({
    ...
    fragmentShader: `
      ...
      float fbm(vec3 p){float v=0.0,a=0.5;for(int i=0;i<${quality === 'high' ? 6 : 4};i++){v+=a*n(p);p*=2.1;a*=0.5;}return v;}
      void main(){
  ...
  return (
    <>
      <fogExp2 attach="fog" args={['#040a16', 0.000045]} />
